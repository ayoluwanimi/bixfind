...
// Supabase Auth handles transactional emails (password reset, confirmation)
// when SMTP is configured in the Supabase Dashboard under Authentication > Settings.
// This function is reserved for future custom email needs.
export async function sendEmail(emailData: any) {
  console.log('Email requested (configure SMTP in Supabase dashboard):', emailData.to, emailData.subject);

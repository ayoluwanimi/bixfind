...
// Auth is handled by Supabase — no local password hashes stored
export const fallbackUsers = {
  'test_user': {
    id: 'test_user',
    email: 'test@bixfind.indevs.in',
    fullName: 'Test User',
    phone: '1234567890',
    userType: 'user',
    isActive: true,
...
// Admin credentials - must be set via ADMIN_EMAIL / ADMIN_PASSWORD env vars
